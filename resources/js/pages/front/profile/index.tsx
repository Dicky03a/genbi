...
export default function ProfileIndex({ about }: ProfileProps) {
    ...
    return (
        <div ref={containerRef} className="min-h-screen bg-white font-sans text-[#1d1d1f]">
            <Head title="Profil GenBI" />
            <PublicNavbar />

            <main className="pt-[20px]">
                {/* Hero Profile Section - Apple Display Style */}
                <section ref={heroRef} className="bg-white py-[80px] md:py-[120px]">
                    <div className="mx-auto max-w-[980px] px-6 text-center">
                        <h1 className="text-[40px] font-semibold leading-[1.07] tracking-[-0.02em] text-[#1d1d1f] md:text-[56px] lg:tracking-[-0.28px]">
                            {about.tagline || 'Energi Untuk Negeri.'}
                        </h1>
                        <p className="mt-8 text-[21px] leading-[1.47] text-[#1d1d1f] md:text-[24px] md:font-light md:leading-[1.5]">
                ...
                <section 
                    ref={addToRefs}
                    className="bg-[#f5f5f7] py-[80px] md:py-[100px]"
                >
                    <div className="mx-auto max-w-[1200px] px-6">
                        <div className="rounded-[32px] bg-white p-8 shadow-sm ring-1 ring-[#e0e0e0] md:p-16">
                            <div className="mb-12 space-y-4">
                                <h2 className="text-[34px] font-semibold tracking-tight text-[#1d1d1f] md:text-[48px]">
                                    Sejarah & Profil
                                </h2>
                ...
                <section 
                    ref={addToRefs}
                    className="bg-white py-[80px] md:py-[120px]"
                >
                    <div className="mx-auto max-w-[1200px] px-6">
                        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
                            {/* Vision Card - Parchment Style */}
                            <div className="flex flex-col justify-center rounded-[32px] bg-[#f5f5f7] p-8 md:p-12">
                                <div className="mb-8 space-y-2">
                                    <h2 className="text-[28px] font-semibold tracking-tight text-[#1d1d1f] md:text-[34px]">
                                        Visi Kami
                                    </h2>
                                    <div className="h-1 w-12 rounded-full bg-[#0066cc]" />
                                </div>
                                <blockquote className="text-[21px] font-light leading-[1.5] italic text-[#1d1d1f] md:text-[28px]">
                                    "{stripHtml(about.vision)}"
                                </blockquote>
                            </div>

                            {/* Mission Card - Dark Tile Style */}
                            <div className="rounded-[32px] bg-[#272729] p-8 text-white md:p-12 shadow-xl">
                                <div className="mb-8 space-y-2">
                ...
                <section 
                    ref={addToRefs}
                    className="bg-[#f5f5f7] py-[80px] md:py-[120px]"
                >
                    <div className="mx-auto max-w-[980px] px-6 text-center">
                        <h2 className="mb-8 text-[34px] font-semibold tracking-tight text-[#1d1d1f] md:text-[48px]">
