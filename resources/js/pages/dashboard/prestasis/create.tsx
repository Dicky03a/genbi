...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Tambah Prestasi', href: '/dashboard/prestasis/create' },
];
...
export default function PrestasiCreate({ users }: Props) {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold tracking-tight">Tambah Data Prestasi</h1>
                        <p className="text-muted-foreground">Isi formulir berikut untuk menambahkan prestasi baru.</p>
                    </div>
                </div>
