...
export default function UsersEdit({ user, roles, divisions }: Props) {
    ...
    const { data, setData, post, errors, processing } = useForm({
        ...
        role:        user.role ?? '',
        division_id: user.division_id ? String(user.division_id) : '' as string,
    });
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    <div className="grid gap-2">
                                        ...
                                        <Input id="password" type="password" value={data.password} onChange={(e) => setData('password', e.target.value)} placeholder="Kosongkan jika tidak ingin mengubah" />
                        ...
                        <div className="space-y-6">
                            <Card>
                                ...
                                <CardContent className="space-y-3">
                                    {currentAvatar && (
                                        <img src={currentAvatar} alt="Avatar" className="h-32 w-32 rounded-full object-cover mx-auto" />
                                    )}
