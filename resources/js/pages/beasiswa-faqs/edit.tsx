...
export default function BeasiswaFaqEdit({ faq }: Props) {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        {
            title: 'Edit',
            href: `/dashboard/beasiswa-faqs/${faq.id}/edit`,
        },
    ];
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('beasiswa-faqs.update', faq.id));
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Edit Beasiswa FAQ" />
